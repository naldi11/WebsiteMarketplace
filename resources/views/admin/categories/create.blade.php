...
@section('content')
    <div class="max-w-xl mx-auto">
        <div class="mb-8">
            <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Tambah Kategori Baru</h1>
            <p class="text-gray-500 mt-1">Buat kategori untuk mengelompokkan produk.</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">Icon (Opsional)</label>
