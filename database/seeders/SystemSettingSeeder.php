...
class SystemSettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        \App\Models\SystemSetting::updateOrCreate(
            ...
            [
                ...
                'value' => "Syarat & Ketentuan Penggunaan Platform:\n\n" .
                    ...
                    "   - Kurir Motor (Untuk barang ringan/sedang s/d 20 kg, dimensi kecil):\n" .
                    "     * Jarak <= 5 km: Rp 15.000 (Flat).\n" .
                    "     * Jarak > 5 km: Rp 15.000 + Rp 3.000 per km tambahan.\n" .
                    "   - Becak (Bentor/Becak Barang untuk barang s/d 100 kg, ukuran sedang):\n" .
                    "     * Jarak <= 5 km: Rp 40.000 (Flat).\n" .
                    "     * Jarak > 5 km: Rp 40.000 + Rp 3.500 per km tambahan.\n" .
                    "   - Mobil Pickup (Untuk barang berat > 100 kg, barang bekas besar, atau barang pindahan):\n" .
                    "     * Jarak <= 5 km: Rp 80.000 (Flat).\n" .
                    "     * Jarak > 5 km: Rp 80.000 + Rp 5.000 per km tambahan.\n" .
                    "   - Penentuan Opsi Kendaraan: Pembeli memilih opsi kendaraan saat checkout. Jika berat total barang > 100 kg atau produk memiliki kategori 'Barang Pindahan', sistem menyarankan/mewajibkan opsi Mobil Pickup.\n" .
                    ...
                    "   - Jika Pembeli sudah menerima barang namun tidak melakukan konfirmasi, sistem akan menyelesaikan pesanan secara otomatis (Auto-Complete) setelah 3 hari sejak barang dikirim oleh Penjual. Saldo/dana akan otomatis diteruskan ke saldo Penjual setelah pemotongan biaya platform.\n" .
        ...
        \App\Models\SystemSetting::updateOrCreate(
            ...
            [
                'description' => 'Persentase Biaya Layanan Platform (%)',
                'value' => '10'
            ]
        );
    }
